...
public class SalaFr extends Fragment {
    RecyclerView rv;
    ...
    public static SalaFr newInstance(String param1, String param2) {
        SalaFr fragment = new SalaFr();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rv = (RecyclerView) v.findViewById(R.id.recyclerResSal);
