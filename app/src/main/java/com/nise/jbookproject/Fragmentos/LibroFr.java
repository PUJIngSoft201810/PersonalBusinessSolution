...
public class LibroFr extends Fragment {
    RecyclerView rv;
    ...
    public static LibroFr newInstance(String param1, String param2) {
        LibroFr fragment = new LibroFr();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rv = (RecyclerView) v.findViewById(R.id.recyclerResLib);
