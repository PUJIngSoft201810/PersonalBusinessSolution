 ...
 * Use the {@link Dia3#newInstance} factory method to
...
public class Dia3 extends Fragment {
    ...
    private static final String TAG = "Dia3";
     ...
     * @return A new instance of fragment Dia3.
     */
    // TODO: Rename and change types and number of parameters
    public static Dia3 newInstance(Sala param1, Date param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_dia3, container, false);

        horas = new ArrayList<Reserva>();

        recyclerView = (RecyclerView) v.findViewById(R.id.dia3RecyclerHoras);
        ...
        titulo = v.findViewById(R.id.tituloDia3);
        titulo.setText("");
