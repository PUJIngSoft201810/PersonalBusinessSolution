...
public class TelevisionFr extends Fragment {
    RecyclerView rv;
    ...
    public static TelevisionFr newInstance(String param1, String param2) {
        TelevisionFr fragment = new TelevisionFr();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_television, container, false);

        mAuth = FirebaseAuth.getInstance();
        //TODO COMPROBAR QUE EL USUARIO SEA FUNCIONARIO O ACADEMICO

        rv = (RecyclerView) v.findViewById(R.id.recyclerResTel);
