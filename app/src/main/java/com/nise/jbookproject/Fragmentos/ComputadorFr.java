...
public class ComputadorFr extends Fragment {
    RecyclerView rv;
    ...
    public static ComputadorFr newInstance(String param1, String param2) {
        ComputadorFr fragment = new ComputadorFr();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_computador, container, false);

        mAuth = FirebaseAuth.getInstance();
        //TODO COMPROBAR QUE EL USUARIO SEA FUNCIONARIO O ACADEMICO

        rv = (RecyclerView) v.findViewById(R.id.recyclerResComp);
